...
void ShaderVariantCollections::RegisterPragram(std::string programName, ShaderProgramPack pack)
{
...
void ShaderVariantCollections::ActivateShaderFeature(std::string programName, ShaderFeature feature)
{
...
void ShaderVariantCollections::DeactiveShaderFeature(std::string programName, ShaderFeature feature)
{
	assert(IsProgramValid(programName) && "Program does not exist in SVC!");
...
void ShaderVariantCollections::SetShaderPrograms(std::map<std::string, ShaderProgramPack> program)
{
	m_shaderPrograms = cd::MoveTemp(program);
}

bool ShaderVariantCollections::IsProgramValid(std::string programName) const
{
